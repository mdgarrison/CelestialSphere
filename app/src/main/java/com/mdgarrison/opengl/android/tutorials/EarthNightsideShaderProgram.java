...
public class EarthNightsideShaderProgram extends ShaderProgram {
	...
	public EarthNightsideShaderProgram(Context context) {
		super(context);
	}
	...
	public int assembleShaderProgram() {
    	...
    	String vertShaderSource = TextResourceReader.readTextFileFromResource(mContext, R.raw.nightside_vertex_shader);
        String fragShaderSource = TextResourceReader.readTextFileFromResource(mContext, R.raw.nightside_fragment_shader);
